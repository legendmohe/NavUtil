...
public class NavFragmentActivity extends AppCompatActivity {
    private static final String TAG = "NavFragmentActivity";
            ...
            Observable.interval(1, TimeUnit.SECONDS)
                    ...
                    .subscribe(new Subscriber<Long>() {
                        ...
                        public void onCompleted() {
                            Log.d(TAG, hint + "onCompleted() called");
                        }
                        ...
                        public void onNext(Long aLong) {
                            Log.d(TAG, hint + "onNext() called with: aLong = [" + aLong + "]");
                        }
                    });
        }
    }
